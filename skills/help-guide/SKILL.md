...
- **Concrete, from the map — never invented.** Every capability you name traces to the capability index; if you're unsure it's real, say so rather than promising it.
