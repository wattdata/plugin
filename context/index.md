...
- **guide** — the capability/how-to answers ("what can I do", "how do I build an audience", "what are signals", "what strategies exist"), straight from this index, plus "what's new / what changed in this version / am I up to date" from the shipped changelog. Touches no graph; points to the command that does the job.
